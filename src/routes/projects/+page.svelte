...
<header class="text-ink mx-auto flex max-w-[65ch] flex-col gap-4 p-4 lg:max-w-6xl xl:max-w-7xl">
...
<div class="mx-auto mt-4 space-y-8 px-4 lg:max-w-6xl xl:max-w-7xl">

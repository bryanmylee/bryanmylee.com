...
<header class="mx-auto lg:max-w-6xl xl:max-w-7xl max-w-[65ch] p-8 space-y-4">
...
<div class="mx-auto px-8 [&_p]:leading-7 [&_p]:text-gray-800 space-y-8 lg:max-w-6xl xl:max-w-7xl">

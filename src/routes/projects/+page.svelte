...
<header class="mx-auto max-w-[65ch] flex flex-col gap-4 p-4 lg:max-w-6xl xl:max-w-7xl">
...
<div
	class="mx-auto mt-4 flex flex-col gap-8 px-4 lg:max-w-6xl xl:max-w-7xl"
>
